...
void Create(int** a, const int rowCount, const int colCount, const int Low, const int High, int i);

void Print(int** a, const int rowCount, const int colCount, int i);
void Sort(int** a, const int rowCount, const int colCount, int i);
...
void Change(int** a, const int row1, const int row2, const int colCount, int j, int tmp)
{
    tmp = a[row1][j];
    a[row1][j] = a[row2][j];
    a[row2][j] = tmp;
    ...
    if (j<colCount-1)
    {
        Change(a, row1, row2, colCount, j, tmp+1);
    }
